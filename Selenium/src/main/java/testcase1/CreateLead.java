...
public class CreateLead extends ProjectMethods {
	...
	public void setDate() {
		...
		excelFileName ="./data/data1.xlsx";

	}
	
	@Test(dataProvider="fetchData")
	public void createLead(String cName,String fName,String lName ,String emailId ,String phoneNum ) throws InterruptedException{
